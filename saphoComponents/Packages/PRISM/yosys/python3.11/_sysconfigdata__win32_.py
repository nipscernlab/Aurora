...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/usr/bin/x86_64-w64-mingw32-gcc -shared '
 ...
 'CCSHARED': '',
 'CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -DMS_WINDOWS '
           '-DMS_WIN32 -DMS_WIN64',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-DMS_WINDOWS -DMS_WIN32 -DMS_WIN64',
 ...
 'CONFIG_ARGS': "'--prefix=/yosyshq' '--host=x86_64-w64-mingw32' "
                "'--build=x86_64-redhat-linux' '--enable-shared' "
                "'--with-system-expat' '--with-suffix=.exe' "
                "'--enable-loadable-sqlite-extensions' '--with-ensurepip=no' "
                "'--with-build-python=/work/_builds/windows-x64/python3/python3-native/yosyshq/bin/python3.11' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/work/_builds/windows-x64/python3/python3/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/work/_builds/windows-x64/python3/python3/lcov-report',
 ...
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 'EXT_SUFFIX': '.cpython-311.dll',
 'FILEMODE': 644,
 'FLOAT_WORDS_BIGENDIAN': 0,
 'FREEZE_MODULE': '/work/_builds/windows-x64/python3/python3-native/yosyshq/bin/python3.11 '
                  './Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/work/_builds/windows-x64/python3/python3-native/yosyshq/bin/python3.11 '
                            './Programs/_freeze_module.py',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/usr/bin/x86_64-w64-mingw32-g++ -shared '
                '-Wl,--enable-auto-image-base',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11.dll.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/usr/bin/x86_64-w64-mingw32-gcc -shared '
             '-Wl,--enable-auto-image-base',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBEXPAT_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -DMS_WINDOWS '
                    '-DMS_WIN32 -DMS_WIN64 -std=c11 -Wextra '
 ...
 'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 '
                    ...
                    '-Wall -DMS_WINDOWS -DMS_WIN32 -DMS_WIN64 -std=c11 -Wextra '
                    '-Wno-unused-parameter -Wno-missing-field-initializers '
                    '-Wstrict-prototypes -Werror=implicit-function-declaration '
                    '-fvisibility=hidden  -I./Include/internal -I. -I./Include',
 'LIBMPDEC_HEADERS': '\\',
 ...
 'LIBPL': '/yosyshq/lib/python3.11/config-3.11',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.11.a',
 'LIBRARY_DEPS': 'libpython3.11.a libpython3.11.dll.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lintl -ldl  -lpthread -lversion -lshlwapi -lpathcch -lbcrypt',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/usr/bin/x86_64-w64-mingw32-gcc',
 'LINKFORSHARED': '',
 ...
 'LN': 'ln',
 'LOCALMODLIBS': '-lws2_32                   -lws2_32 -liphlpapi     -lwinmm',
 'MACHDEP': 'win32',
 'MACHDEP_OBJS': 'PC/dl_nt.o',
 'MACHDESTLIB': '/yosyshq/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': '/usr/bin/x86_64-w64-mingw32-gcc',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODBUILT_NAMES': 'atexit  faulthandler  nt  _signal  _tracemalloc  _codecs  '
                   ...
                   '_symtable  winreg  _socket  mmap  msvcrt  _winapi  '
                   'winsound  _overlapped  xxsubtype',
 'MODDISABLED_NAMES': '',
 'MODLIBS': '-lws2_32                   -lws2_32 -liphlpapi     -lwinmm',
 'MODOBJS': 'Modules/atexitmodule.o  Modules/faulthandler.o  '
            ...
            'Modules/../PC/winreg.o  Modules/socketmodule.o  '
            'Modules/mmapmodule.o  Modules/../PC/msvcrtmodule.o  '
            'Modules/_winapi.o  Modules/../PC/winsound.o  '
            'Modules/overlapped.o  Modules/xxsubtype.o',
 'MODSHARED_NAMES': '',
 ...
 'MODULE_MMAP_LDFLAGS': '',
 'MODULE_MMAP_STATE': 'missing',
 'MODULE_MSVCRT_LDFLAGS': '',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/work/_builds/windows-x64/python3/python3 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/work/_builds/windows-x64/python3/python3/`cat '
                     'pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__win32_ '
                     '/work/_builds/windows-x64/python3/python3-native/yosyshq/bin/python3.11',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/work/_builds/windows-x64/python3/python3-native/yosyshq/bin/python3.11',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha256,sha512,sha3,blake2"',
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                             '-DMS_WINDOWS -DMS_WIN32 -DMS_WIN64 -std=c11 '
 ...
 'PY_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -DMS_WINDOWS '
              '-DMS_WIN32 -DMS_WIN64',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -DMS_WINDOWS '
                   '-DMS_WIN32 -DMS_WIN64 -std=c11 -Wextra '
                   '-Wno-unused-parameter -Wno-missing-field-initializers '
                   '-Wstrict-prototypes -Werror=implicit-function-declaration '
                   '-fvisibility=hidden  -I./Include/internal -I. -I./Include '
                   '-DPy_BUILD_CORE -DMS_WINDOWS -DMS_COREDLL '
                   '-DMS_DLL_ID=\\"3.11\\" '
                   '-DPY3_DLLNAME=\\"libpython3.11.dll\\"',
 'PY_CORE_LDFLAGS': '',
 ...
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                        '-DMS_WINDOWS -DMS_WIN32 -DMS_WIN64 -std=c11 -Wextra '
                        '-Wno-unused-parameter -Wno-missing-field-initializers '
                        '-Wstrict-prototypes '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I./Include/internal -I. '
 ...
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-lintl -ldl  -lpthread -lversion -lshlwapi -lpathcch -lbcrypt',
 'SHLIB_SUFFIX': '.dll',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/work/_builds/windows-x64/python3/python3 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/work/_builds/windows-x64/python3/python3/`cat '
               'pybuilddir.txt`:)./Lib '
               ...
               '/work/_builds/windows-x64/python3/python3-native/yosyshq/bin/python3.11',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/work/_builds/windows-x64/python3/python3 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/work/_builds/windows-x64/python3/python3/`cat '
               'pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/work/_builds/windows-x64/python3/python3',
 'abs_srcdir': '/work/_builds/windows-x64/python3/python3',
